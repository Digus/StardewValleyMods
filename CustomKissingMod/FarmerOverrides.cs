...
namespace CustomKissingMod
{
    internal class FarmerOverrides
    {
        ...
        {
            if (__result != true && who.IsLocalPlayer)
            {
                if (!__instance.isMoving() && !__instance.isInBed.Value && __instance.ActiveObject == null && who.ActiveObject == null && !__instance.FarmerSprite.PauseForSingleAnimation && !who.FarmerSprite.PauseForSingleAnimation)
                {
