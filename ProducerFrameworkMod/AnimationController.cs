...
namespace ProducerFrameworkMod
{
    ...
    {
        public static void DisplayAnimation(PlacingAnimation animation, Color animationColor, GameLocation currentLocation, Vector2 tileLocation)
        {
            ...
            switch (animation)
            {
                case PlacingAnimation.Bubbles:
                    multiplayer.broadcastSprites(currentLocation, new TemporaryAnimatedSprite[1]
                    {
                        new TemporaryAnimatedSprite("TileSheets\\animations",
                            ...
                            tileLocation * 64f + new Vector2(0.0f, (float) sbyte.MinValue), false, false,
                ...
                case PlacingAnimation.Fire:
                    multiplayer.broadcastSprites(currentLocation, new TemporaryAnimatedSprite[1]
                    {
                        new TemporaryAnimatedSprite(30, tileLocation * 64f + new Vector2(0.0f, -16f), animationColor, 4, false,
